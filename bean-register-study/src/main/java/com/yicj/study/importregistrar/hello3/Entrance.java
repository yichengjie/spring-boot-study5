package com.yicj.study.importregistrar.hello3;


import com.yicj.study.importregistrar.hello3.component.OutSide;
import org.springframework.context.annotation.*;

@Import(OutSide.class)
@Configuration
@EnableAspectJAutoProxy
@ComponentScan("com.yicj.study.importregistrar.hello3")
